...
import type { FinanceExpenseStateProps } from '../api/types';
import styles from '../../style.scss.module.scss';

type FinanceOverviewExpenseHeaderProps = FinanceExpenseStateProps;

const FinanceOverviewExpenseHeader: FunctionComponent<FinanceOverviewExpenseHeaderProps> = (
  props: FinanceOverviewExpenseHeaderProps
): JSX.Element => {
      ...
      <div className={styles.headerActions}>
        <div className={styles.searchForm}>
          <input
            ...
            type="text"
            placeholder="Search category, remarks or amount ..."
          ...
          <div className={styles.headerActionControls}>
            <button
              ...
              disabled={state.load}
              title="Reload expense records"
              aria-label="Reload expense records"
            >
            ...
            <button
              ...
              title={hasActiveDateFilter ? 'Change date filter' : 'Filter expenses by date'}
              aria-label={hasActiveDateFilter ? 'Change date filter' : 'Filter expenses by date'}
        ...
        <div className={styles.filterPopoverBody}>
          <div className={styles.filterPopoverHeader}>
            ...
            <p className={styles.filterPopoverSubtitle}>
              Narrow expense records using an inclusive start and end date.
            </p>
          </div>
...
export default FinanceOverviewExpenseHeader;
