...
const AppointmentHeader: FunctionComponent<AppointmentHeaderProps> = (
  ...
  const { state, setState, onReload, activeTab } = props;
        ...
        <div className={styles.searchForm}>
          ...
          <div className={styles.headerActionControls}>
            ...
            <button
              ...
              title={hasActiveDateFilter ? 'Change date filter' : 'Filter appointments by date'}
              aria-label={
                hasActiveDateFilter ? 'Change date filter' : 'Filter appointments by date'
              }
        ...
        <div className={styles.filterPopoverBody}>
          <div className={styles.filterPopoverHeader}>
            ...
            <p className={styles.filterPopoverSubtitle}>
              Narrow appointments using an inclusive start and end date.
            </p>
          </div>
